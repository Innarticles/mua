Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "mua_#{Rails.env}"
  ...
  config.action_mailer.default_url_options = {
    host: "https://git.heroku.com/muaappproduction.git",
    protocol: "https"
  }
  config.action_mailer.asset_host = "https://https://git.heroku.com/muaappproduction.git"
